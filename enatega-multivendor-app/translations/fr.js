export const fr = {
  ...
  welcome:
    "Bienvenue chez NextHop, parfois tout ce dont vous avez besoin, c'est de l'amour. Mais un peu de nourriture de temps en temps ne fait pas de mal.",
  welcomeScreen: 'Bienvenue chez NextHop',
  ...
  enategaUseYourLocationMessage:
    'NextHop utilise votre emplacement pour afficher les restaurants à proximité de chez vous !',
