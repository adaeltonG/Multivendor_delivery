      ...
      <Grid container item xs={12} className={classes.FAQContainer}>
        ...
        <Grid container item xs={10} sm={10} md={9}>
          <Typography variant="h4" className={classes.FAQTitle}>
            Order food online from the best restaurants and shops on NextHop
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Are you hungry? Had a long and busy day? Then NextHop is the right place for you! NextHop, offers you a long
            and detailed <b>list of the best restaurants near you</b>. Whether it is a delicious Pizza, Burger, Japanese
            or any kind of Fast Food you are craving, NextHop has an extensive roaster restaurants available for you to{" "}
          ...
          <Grid item xs={12}>
            <List disablePadding>
              ...
              <ListItem divider alignItems="flex-start" disableGutters style={{ padding: "0px", marginBottom: "10px" }}>
                ...
                <ListItemText primary="NEW: NextHop grocery delivery! Discover the best shops, pharmacies, bakeries and more near you." />
              </ListItem>
            </List>
          </Grid>
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            How can I get NextHop delivery?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            To get NextHop delivery, simply locate the restaurants near you by typing in your address, browse through a
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            Does NextHop deliver 24 hours?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, NextHop in Pakistan delivers 24 hours. However, many restaurants may be unavailable for a late night
            delivery. Please check which places in Pakistan deliver to you 24 hours by using your address.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            Can you pay cash for NextHop?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, you can pay cash on delivery for NextHop in Pakistan.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            How can I pay NextHop online?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            You can pay online while ordering at NextHop Pakistan by using a credit or debit card or PayPal.
          </Typography>
          <Typography variant="h6" className={classes.FAQTitle}>
            Can I order NextHop for someone else?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Yes, NextHop Pakistan allows you to place an order for someone else. During checkout, just update the name
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            How much does NextHop charge for delivery?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
            Delivery fee charged by NextHop in Pakistan depends on many operational factors, most of all - location and
          ...
          <Typography variant="subtitle1" className={classes.FAQAns}>
            There are hundreds of restaurants on NextHop Pakistan that let you order online. For example, KFC,
          ...
          <Typography variant="h6" className={classes.FAQTitle}>
            Does NextHop have minimum order?
          </Typography>
          <Typography variant="subtitle1" className={classes.FAQAns}>
