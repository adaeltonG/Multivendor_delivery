const fr = {
  translation: {
    ...
    footerText:
      "NextHop est une plateforme open source de gestion des livraisons pour le avenir. Nous accordons la priorité à l innovation, à la flexibilité et à l abordabilité, et offrez une solution évolutive et personnalisable qui rationalise votre processus de livraison.",
    footerLinkHome: "Accueil",
    footerLinkPP: "Politique de confidentialité",
    footerLinkTC: "Conditions générales",
    footerEndText: "NextHop - © 2022 Tous droits réservés",
    ...
    createAccount: "Créez votre compte NextHop",
