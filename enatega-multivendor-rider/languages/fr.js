export const fr = {
  ...
  welcome:
    "Bienvenue dans NextHop, parfois tout ce dont vous avez besoin est de l'amour. Mais un peu de nourriture maintenant et ensuite ne fait pas mal.",
...
locationAccess: 'Accès à la localisation',
    ...
    enategaLocationText: 'NextHop utilise votre emplacement pour des fonctionnalités telles que la recherche de commandes à proximité et le suivi des commandes des clients !',
    emptyUsernameError: 'Le nom dutilisateur est requis!',
emptyPasswordError: 'Le mot de passe est requis!',
loginFlashMsg: 'Connecté',
enategaCash: 'NextHop Argent Liquide',
ASSIGNED: "ASSIGNÉ",
PICKED: "CHOISI",
