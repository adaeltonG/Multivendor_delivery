const ar = {
  translation: {
    ...
    saveButton: "يحفظ",
    footerText:
      "NextHop عبارة عن منصة مفتوحة المصدر لإدارة التسليم لـ مستقبل. نحن نعطي الأولوية للابتكار والمرونة والقدرة على تحمل التكاليف، وتقديم حل قابل للتطوير وقابل للتخصيص يعمل على تبسيط عملك عمليات التسليم.",
    footerLinkHome: "الصفحة الرئيسية",
    footerLinkPP: "سياسة الخصوصية",
    footerLinkTC: "الشروط والأحكام",
    footerEndText: "NextHop - © 2022 جميع الحقوق محفوظة",
    followUs: "تابعنا",
    ...
    createAccount: "أنشئ حسابك في NextHop",
